...
client.on("guildMemberAdd", member => {
  ...
  .setColor(0xF75762)
  .setImage('https://lh3.googleusercontent.com/l-9Cie5TSnzti1fdAkmBevlM_QYoUGz7E0_MRA_nnPTEkIIEVQPN3oHD4o0xvBFrsirchQ=s170')
  .setAuthor(member.displayName, member.user.displayAvatarURL())
    channelWelcome.send(embed).then(member => member.react('👋'));
});

client.on('message', msg => { // hay que cerrar este
